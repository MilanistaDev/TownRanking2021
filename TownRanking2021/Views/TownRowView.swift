    ...
    static var previews: some View {
        Group {
            TownRowView(selection: .rent, townInfo: dummyTownRankingData.townRankingsForRent[0])
                ...
                .padding()
                .previewDisplayName("Rank 1-3")
            TownRowView(selection: .rent, townInfo: dummyTownRankingData.townRankingsForRent[3])
                .previewLayout(PreviewLayout.sizeThatFits)
                .padding()
                .previewDisplayName("Rank 4-10")
            TownRowView(selection: .buy, townInfo: dummyTownRankingData.townRankingsForBuy[0])
                .previewLayout(PreviewLayout.sizeThatFits)
                .padding()
                .previewDisplayName("Rank 1-3")
            TownRowView(selection: .buy, townInfo: dummyTownRankingData.townRankingsForBuy[3])
                .previewLayout(PreviewLayout.sizeThatFits)
                .padding()
                .previewDisplayName("Rank 4-10")
            TownRowView(selection: .rent, townInfo: dummyTownRankingData.townRankingsForRent[0])
                ...
                .previewDisplayName("Dark Mode Rank 1-3")
            TownRowView(selection: .rent, townInfo: dummyTownRankingData.townRankingsForRent[3])
                .previewLayout(PreviewLayout.sizeThatFits)
                .padding()
                .background(Color(.systemBackground))
                .environment(\.colorScheme, .dark)
                .previewDisplayName("Dark Mode Rank 4-10")
            TownRowView(selection: .buy, townInfo: dummyTownRankingData.townRankingsForBuy[0])
                .previewLayout(PreviewLayout.sizeThatFits)
                .padding()
                .background(Color(.systemBackground))
